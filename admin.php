...
$password = mysqli_real_escape_string($link,$password);
   ...
   // mysql_connect("localhost", "root", "");
    ...
    $result = mysqli_query($link,"select * from admin where usermail = '$usermail' and password = '$password'") 
...
if($usermail==''||$password==''){
    ...
    else if ($row['usermail'] == $usermail && $row['password'] == $password ){
        $redirect_page = 'http://localhost/blueLine%20Health%20Care/doctorForm.php';
